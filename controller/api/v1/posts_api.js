...
/*
Code to delete the post without any Authentication(that is check whether user is authorized to delete that is is he the same persone who created the post)


We can copy the same code of destroy function from posts_controller and also removing flash messages since its api , we will be sending json data in it
...
module.exports.destroy = async function(request,response){
    ...
    try{
        ...
        //checking if user is authorized to delete i.e is he the same person who created the post?
